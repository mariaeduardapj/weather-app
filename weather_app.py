...
temp_label = ctk.CTkLabel(text_info_frame, text="", font=("Arial", 48, "bold"), text_color="#FF4500")
temp_label.pack(pady=(0, 0), anchor='w')
desc_label = ctk.CTkLabel(text_info_frame, text="", font=("Arial", 14), justify="left")
desc_label.pack(pady=(5, 0), anchor='w') 
city_label = ctk.CTkLabel(text_info_frame, text="", font=("Arial", 22, "bold"), justify="left")
city_label.pack(pady=(0, 0), anchor='w') 
feel_label = ctk.CTkLabel(text_info_frame, text="", font=("Arial", 18), text_color="#696969", justify="left")
feel_label.pack(pady=(0, 5), anchor='w')
humidity_label = ctk.CTkLabel(text_info_frame, text="", font=("Arial", 14), justify="left")
humidity_label.pack(pady=(0, 0), anchor='w')
max_min_label = ctk.CTkLabel(text_info_frame, text="", font=("Arial", 14), justify="left")
max_min_label.pack(pady=(5, 0), anchor='w')
app.mainloop()
